...
```text
{{</* deprecated-in 0.144.0 */>}}
Use [`hugo.IsServer`](/docs/reference/functions/hugo/isserver/) instead.
{{</* /deprecated-in */>}}
```
...
<<<<<<< HEAD:content/en/contribute/documentation.md
Use the [new-in](#new-in) shortcode to indicate a new feature.
=======
Use the [new-in shortcode](#new-in) to indicate a new feature.
>>>>>>> 781b89ca0 (content: Restructure using the Diátaxis model):content/en/docs/contribute/documentation/index.md
