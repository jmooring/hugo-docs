...
In March 2025 we began transitioning to the [Diátaxis](https://diataxis.fr) documentation model.
...
[The Good Docs Project] provides a useful, open-source [template repository] that supports the Diataxis model:
...
12|`params.minversion`|Applicable to tutorials and guides: the minimum Hugo version required||
...
There are five callout types: `note`, `important`, `tip`, `warning`, and `caution`. These are the usage statistic as of 16 March 2025, including usage on this page:
