...
With `class` and `id` attributes, whether you use long-form or short-form notation, the resulting values are available in [Markdown render hooks][] via the `Attributes` method. For example:
...
[option]: /docs/reference/functions/transform/highlight/#options
