...
Templates use [variables](#variables), [functions](#functions), and [methods](#methods) to transform your content, resources, and data into a published page.
...
In the example above the dot represents the `Page` object, and we call its [`Title`][page_title] method to return the title as defined in [front matter][].
...
`Page`|[`Params`][params_page]|Returns a map of custom parameters as defined in the front matter of the given page.
...
`Site`|[`Params`][params_site]|Returns a map of custom parameters as defined in your project configuration.
`Site`|[`Title`][site_title]|Returns the title as defined in the your project configuration.
...
[`safe.HTML`]: /docs/reference/functions/safe/html/
...
[front matter fields]: /docs/reference/front-matter/#fields
...
[params_page]: /docs/reference/methods/page/params/
[params_site]: /docs/reference/methods/site/params/
