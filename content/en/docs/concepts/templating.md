...
Function|Alias
:--|:--
[`strings.ToLower`](/docs/reference/functions/strings/tolower)|`lower`
[`strings.ToUpper`](/docs/reference/functions/strings/toupper)|`upper`
[`strings.Replace`](/docs/reference/functions/strings/replace)|`replace`
...
[`seq`]: /docs/reference/functions/collections/seq
