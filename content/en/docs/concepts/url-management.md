...
categories: []
keywords: []
latest_alias: /content-management/urls/
old_aliases: [/extras/permalinks/,/extras/aliases/,/extras/urls/,/doc/redirects/,/doc/alias/,/doc/aliases/]
---
...
{{% include "/docs/_common/permalink-tokens.md" %}}
...
[`disableAliases`]: /docs/reference/configuration/all/#disablealiases
[`isHTML`]: /docs/reference/configuration/output-formats/#ishtml
[`permalinkable`]: /docs/reference/configuration/output-formats/#permalinkable
[aliases_field]: /docs/reference/front-matter/#aliases
[aliases_method]: /docs/reference/methods/page/aliases/
