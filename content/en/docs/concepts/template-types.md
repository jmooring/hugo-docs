...
The `block` construct above is used to define a set of root templates that are then customized by redefining the block templates within. See&nbsp;[details](/docs/reference/functions/go-template/block/).
...
[`Taxonomy`]: /docs/reference/methods/taxonomy/
