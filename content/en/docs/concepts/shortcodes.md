...
{{% render-list-of-pages-in-section path=/docs/guides/embedded-shortcodes %}}
...
[custom shortcodes]: /docs/guides/custom-shortcodes/
[layout string]: /docs/reference/functions/time/format/#layout-string
[nesting]: /docs/guides/custom-shortcodes/#nesting
[rendering order]: /docs/guides/custom-shortcodes/#rendering-order
