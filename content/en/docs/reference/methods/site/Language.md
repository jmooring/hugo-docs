...
[`languageCode`]: /docs/reference/configuration/languages/#languagecode
[`languageDirection`]: /docs/reference/configuration/languages/#languagedirection
[`languageName`]: /docs/reference/configuration/languages/#languagename
[`weight`]: /docs/reference/configuration/languages/#weight
[default language]: /docs/glossary/#default-language
[details]: /docs/reference/methods/page/language/
