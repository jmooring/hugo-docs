...
[`aliases`]: /docs/reference/front-matter/#aliases
[`strings.FindRE`]: /docs/reference/functions/strings/findre/
[media type]: /docs/reference/configuration/media-types/
[output format]: /docs/reference/configuration/output-formats/
[outputs]: /docs/reference/configuration/outputs/
