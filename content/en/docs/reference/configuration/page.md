...
[`NextInSection`]: /docs/reference/methods/page/nextinsection/
[`Next`]: /docs/reference/methods/page/next/
[`PrevInSection`]: /docs/reference/methods/page/previnsection/
[`Prev`]: /docs/reference/methods/page/prev/
[next-pages]: /docs/reference/methods/pages/next/
[prev-pages]: /docs/reference/methods/pages/prev/
