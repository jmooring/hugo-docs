...
{{% include "/docs/_common/configuration/locale.md" %}}
...
[aliases_front_matter]: /docs/reference/front-matter/#aliases
[aliases_page_method]: /docs/reference/methods/page/aliases/
[automatic summaries]: /docs/concepts/content-summaries/#automatic-summary
[canonical-urls]: /docs/concepts/url-management/#canonical-urls
[client-side redirection]: /docs/concepts/url-management/#client-side-redirection
[composite characters]: https://en.wikipedia.org/wiki/Precomposed_character
[configure HTTP cache]: /docs/reference/configuration/http-cache/
[configure build]: /docs/reference/configuration/build/
[configure cascade]: /docs/reference/configuration/cascade/
[configure deployment]: /docs/reference/configuration/deployment/
[configure file caches]: /docs/reference/configuration/caches/
[configure front matter]: /docs/reference/configuration/front-matter/
[configure imaging]: /docs/reference/configuration/imaging/
[configure languages]: /docs/reference/configuration/languages/
[configure markup]: /docs/reference/configuration/markup/
[configure media types]: /docs/reference/configuration/media-types/
[configure menus]: /docs/reference/configuration/menus/
[configure minify]: /docs/reference/configuration/minify/
[configure modules]: /docs/reference/configuration/modules/
...
[configure page]: /docs/reference/configuration/page/
[configure pagination]: /docs/reference/configuration/pagination/
[configure params]: /docs/reference/configuration/params/
[configure permalinks]: /docs/reference/configuration/permalinks/
[configure privacy]: /docs/reference/configuration/privacy/
[configure related content]: /docs/reference/configuration/related-content/
[configure roles]: /docs/reference/configuration/roles/
[configure security]: /docs/reference/configuration/security/
[configure segments]: /docs/reference/configuration/segments/
[configure server]: /docs/reference/configuration/server/
[configure services]: /docs/reference/configuration/services/
[configure sitemap]: /docs/reference/configuration/sitemap/
[configure taxonomies]: /docs/reference/configuration/taxonomies/
[configure ugly URLs]: /docs/reference/configuration/ugly-urls/
[configure versions]: /docs/reference/configuration/versions/
[define-automatically]: /content-management/menus/#define-automatically
[details]: /docs/concepts/themes/#composite-themes
[duration]: https://pkg.go.dev/time#Duration
[front matter configuration]: /docs/reference/configuration/front-matter/
[language keys]: /docs/reference/configuration/languages/#language-keys
...
[relative-urls]: /docs/concepts/url-management/#relative-urls
[security implications]: /docs/reference/configuration/introduction/#security-implications
[template-metrics]: /docs/troubleshooting/performance/#template-metrics
