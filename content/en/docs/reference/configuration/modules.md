...
`usePackageJSON`
: {{< new-in 0.159.0 />}}
: (`string`) Whether to use the import's npm dependencies in [`hugo mod npm pack`][]. One of `auto` (default), `always` or `never`. When set to `auto`, Hugo will enable this if either there is a Hugo config file (e.g. `hugo.toml`) or a `package.hugo.json` file in the module root.
...
[`archetypeDir`]: /docs/reference/configuration/all/#archetypedir
[`assetDir`]: /docs/reference/configuration/all/#assetdir
[`contentDir`]: /docs/reference/configuration/all/#contentdir
[`dataDir`]: /docs/reference/configuration/all/#datadir
[`hugo mod npm pack`]: /docs/reference/commands/hugo_mod_npm_pack/
[`i18nDir`]: /docs/reference/configuration/all/#i18ndir
[`layoutDir`]: /docs/reference/configuration/all/#layoutdir
[`staticDir`]: /docs/reference/configuration/all/#staticdir
