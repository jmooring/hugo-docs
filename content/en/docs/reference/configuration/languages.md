...
: (`string`) The projects's default content language, conforming to the syntax described in [RFC 5646][]. This value must match one of the defined [language keys][language keys]. Default is `en`.
...
[`Language.Direction`]: /docs/reference/methods/site/language/#direction
[`Language.Label`]: /docs/reference/methods/site/language/#label
[`Title`]: /docs/reference/methods/site/title/
[`dir`]: https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/dir
[`disableDefaultSiteRedirect`]: /docs/reference/configuration/all/#disabledefaultsiteredirect
