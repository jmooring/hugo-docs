...
Environment variables simplify configuration for [CI/CD](g) deployments such as [Cloudflare][], [GitHub Pages][], [GitLab Pages][], [Netlify][], [Render][], and [Vercel][] by allowing you to set values directly within their respective configuration and workflow files.
...
[`environment`]: /docs/reference/configuration/all#environment
