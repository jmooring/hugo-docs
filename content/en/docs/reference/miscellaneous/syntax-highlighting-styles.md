...
[`hugo gen chromastyles`]: /docs/reference/commands/hugo_gen_chromastyles/
[`noClasses`]: /docs/reference/configuration/markup/#noclasses
[`transform.Highlight`]: /docs/reference/functions/transform/highlight/
[configure Markup]: /docs/reference/configuration/markup/#highlight
