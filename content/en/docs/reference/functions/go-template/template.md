...
[`disqus.html`]: /docs/guides/embedded-templates/disqus/
[`google_analytics.html`]: /docs/guides/embedded-templates/google-analytics/
[`opengraph.html`]: /docs/guides/embedded-templates/open-graph/
[`pagination.html`]: /docs/guides/embedded-templates/pagination/
[`partialCached`]: /docs/reference/functions/partials/includecached/
[`return`]: /docs/reference/functions/go-template/return/
[`schema.html`]: /docs/guides/embedded-templates/schema/
[`twitter_cards.html`]: /docs/guides/embedded-templates/twitter-cards/
