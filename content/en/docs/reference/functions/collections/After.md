...
You can use `after` in combination with the [`first`][] function and Hugo's [powerful sorting methods](/docs/reference/quick-reference/page-collections/#sort). Let's assume you have a `section` page at `example.com/articles`. You have 10 articles, but you want your template to show only two rows:
...
[`first`]: /docs/reference/functions/collections/first/
[`slice`]: /docs/reference/functions/collections/slice/
