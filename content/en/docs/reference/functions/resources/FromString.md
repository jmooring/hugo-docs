...
old_aliases: [/hugo-pipes/resource-from-string/]
---
...
[`dict`]: /docs/reference/functions/collections/dictionary/
[`jsonify`]: /docs/reference/functions/encoding/jsonify/
[`resources.ExecuteAsTemplate`]: /docs/reference/functions/resources/executeastemplate/
