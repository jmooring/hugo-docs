...
<<<<<<< HEAD:content/en/functions/css/Sass.md
  DART_SASS_VERSION: 1.87.0
=======
  DART_SASS_VERSION: 1.85.0
>>>>>>> e516014d8 (content: Restructure using the Diátaxis approach):content/en/docs/reference/functions/css/Sass.md
  GIT_DEPTH: 0
  GIT_STRATEGY: clone
...
[site configuration]: /docs/reference/configuration/build/
