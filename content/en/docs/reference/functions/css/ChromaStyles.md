...
[`css.Build`]: /docs/reference/functions/css/build/
[`highlight`]: /docs/guides/embedded-shortcodes/highlight/
[`importContext`]: /docs/reference/functions/css/build/#importcontext
[`partials.IncludeCached`]: /docs/reference/functions/partials/includecached/
[`publishDir`]: /docs/reference/configuration/all/#publishdir
[`style`]: /docs/reference/configuration/markup/#style
[`transform.HighlightCodeBlock`]: /docs/reference/functions/transform/highlightcodeblock/
[`transform.Highlight`]: /docs/reference/functions/transform/highlight/
[global default]: /docs/reference/configuration/markup/#noclasses
[mode]: /docs/reference/miscellaneous/syntax-highlighting-styles/#modes
