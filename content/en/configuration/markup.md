...
To avoid a conflict when enabling the "subscript" feature of the Hugo Goldmark Extras extension, if you want to render subscript and strikethrough text concurrently you must:

1. Disable the Goldmark Strikethrough extension
1. Enable the "deleted text" feature of the Hugo Goldmark Extras extension
